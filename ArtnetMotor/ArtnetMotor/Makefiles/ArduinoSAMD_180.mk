...
#
#
# Last update: 26 Feb 2020 release 11.6.15
#
...
# ----------------------------------
#
REQUIRED_ARDUINO_SAMD_RELEASE = 1.8.5
...
BUILD_CORE       := samd
SUB_PLATFORM     := samd
PLATFORM_TAG      = ARDUINO=10812 ARDUINO_ARCH_SAMD EMBEDXCODE=$(RELEASE_NOW) ARDUINO_$(BUILD_BOARD) $(filter __%__ ,$(GCC_PREPROCESSOR_DEFINITIONS))
...
#    UPLOADER_PATH    = $(OTHER_TOOLS_PATH)/openocd/0.9.0-arduino
    ...
    UPLOADER_COMMAND = telnet_port disabled; program {{$(TARGET_BIN)}} verify reset 0x00004000; shutdown
