...
#
#
# Last update: 04 Feb 2020 release 11.6.8
#
...
ifeq ($(UPLOADER), mspdebug)
    ...
    # mspdebug has moved!
    ifeq ($(shell if [ -f '$(APPLICATION_PATH)/hardware/tools/msp430/bin/mspdebug' ]; then echo 1 ; else echo 2 ; fi ),1)
        UPLOADER_PATH     = $(APPLICATION_PATH)/hardware/tools/msp430/bin
    else
        UPLOADER_PATH     = $(APPLICATION_PATH)/hardware/tools/mspdebug
    endif
